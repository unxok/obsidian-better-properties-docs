...
![More button menu](/public/metadata-editor-more-button.png)
...
When the clicking the icon for a given property, the following menu will be shown. This by itself is built-in to Obsidian.
